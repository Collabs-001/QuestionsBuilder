  ...
  return (
    <>
      <div className="flex justify-center flex-col md:flex-row gap-5">
        <SearchBar searchTopic={searchTopic} setSearchTopicHandler={setSearchTopicHandler} />
        <input
      ...
      <div className="flex justify-center flex-col md:flex-row gap-5">
        ...
        <button
          ...
          className={`p-5 m-5 rounded bg-green-500 font-bold text-lg ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
